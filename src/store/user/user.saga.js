...
export function* signInAfterSigup({payload: {user, additionalDetails}}) {
    yield call(getSnapshotFromUserAuth, user,additionalDetails)
}

export function* onGoogleSignInStart() {
    yield takeLatest(USER_ACTION_TYPES, signInWithGoogle)
}
...
export function* onSignUpStart() {
    yield takeLatest(USER_ACTION_TYPES.EMAIL_SIGN_IN_START, signUp)
}

export function* onSignUpSuccess() {
    yield takeLatest(USER_ACTION_TYPES.SIGN_IN_SUCCESS, signInAfterSigup)
}
